...
namespace ComprehensiveSoftwareForPortableDevice.Hardware
{
    [Serializable]
    public class LaserPen
    {
        ...
        public LaserPen(int _nPenNo, int _nMarkLoop, double _dMarkSpeed, double _dPowerRatio, double _dCurrent, int _nFreq, double _dQPulseWidth,
            ...
            int _nAlign, int _ndpi, int _nminLowGrayPt, int _nbmpScanAttr, int _nbmpttrib, double _dBrightness, double _dContrast, double _dSettingPointTime, double _dRatio, bool _blInvert, bool _blGray, bool _blDither, bool _blBidirectional, bool _blYscan, bool _blDisableMarkLowGray, bool _blPower, bool _blOffSetPT, bool _blOptimize, bool _blDPIfixedWidth, bool _blDPIfixedHeight, bool _blBrightness, bool _blDrill, bool _blfixDPI, bool _blDynamic)
        {
            nPenNo = _nPenNo;
