...
namespace SaraPrinterLaser.Hardware
{
    static class Laser
    {
        ...
        public static Laser.LmcErrCode nErr;
        ...
        public static string LaserCheck(string dir)
        {
            string result = "Faild Connection laser ...";

            IntPtr mes = new IntPtr();
            Laser.LmcErrCode nErr = Laser.Initialize(dir, false, mes);
            if (nErr != Laser.LmcErrCode.LMC1_ERR_SUCCESS)
            {

                result = "Initialize LmcDll failed\nReason:";
