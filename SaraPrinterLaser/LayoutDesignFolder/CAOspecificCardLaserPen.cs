...
{
    [Serializable]
    public class CAOspecificCardLaserPen
    {
        #region properties
        ...
        #endregion
        #region Methods
        public CAOspecificCardLaserPen()
        {

        }
        public CAOspecificCardLaserPen(string _ParametersName,int _nPenNo, int _nMarkLoop, double _dMarkSpeed, double _dPowerRatio, double _dCurrent, int _nFreq, double _dQPulseWidth,
